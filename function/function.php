...
function banner2(){
    ...
    $out = "
$WH       ===================================================================$DEF
                |$GR SCRIPT$DEF  :$MG PAYPAL VALIDATOR                $DEF |
...
function banner3(){
        ...
        $WH   = collorLine("WH");
        $out = "
$RD       NOTE$WH  :$CY  This script requires a proxy to run properly, 
                please paste your proxy in the$WH 'proxy.txt'$CY file 
                and paste your proxy username:password in the
                $WH 'settings.php'$CY file.
               $YL WEBSHARE.IO$CY proxy recommendation.
$WH       ===================================================================$DEF
